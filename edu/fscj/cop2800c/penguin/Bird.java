...
public class Bird implements Comparable<Bird> {
    // private fields
    //instructions showed this should be sampleNumber
    //but this didn't work with the other code
    private int sampleNum; 
    private double culmenLength; //renamed from billLength
    private double culmenDepth; // renamed from billDepth
